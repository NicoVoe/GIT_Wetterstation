...
void nrf_transfer_sync(uint8_t *Buffer_Out, uint8_t *Buffer_In, uint8_t Length);
void nrf_transmit(uint8_t *Buffer_Out, uint8_t Length);
...
uint8_t nrf_modul(uint8_t *Rx_Buffer);
